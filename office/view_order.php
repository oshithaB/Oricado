        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="measurements-grid">
                    ...
                    <p><strong>Covering:</strong> <?php echo $order['covering'] ? ucfirst($order['covering']) : 'N/A'; ?></p>
            ...
            <div class="section">
                ...
                <div class="measurements-grid">
                    ...
                    <p><strong>Color:</strong> <?php echo $order['coil_color'] ? str_replace('_', ' ', ucfirst($order['coil_color'])) : 'N/A'; ?></p>
                </div>
            </div>
            <?php endif; ?>
